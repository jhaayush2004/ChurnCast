...
class ModelTrainer:
    ...
    def get_model_object_and_report(self, train: np.array, test: np.array) -> Tuple[object, object]:
        ...
        Description : This function trains an XGBClassifier with specified parameters.
        ...
        try:
            ...
            # Initialize XGBClassifier with specified parameters from your notebook
            model = XGBClassifier(
            ...
            logging.info(f"Classification metric artifact: {metric_artifact}")
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        ...
        try:
            ...
            logging.info("Model object and metric artifact loaded.")
            ...
            train_accuracy = accuracy_score(train_arr[:, -1], train_preds)

            if train_accuracy < self.model_trainer_config.expected_accuracy:
                logging.info(f"Model accuracy on the training set ({train_accuracy}) is less than the expected threshold ({self.model_trainer_config.expected_accuracy}).")
                raise Exception("No model found with score above the base score.")

            # Save the final model object that includes both preprocessing and the trained model
            logging.info("Saving new model as performance is better than previous one.")
            
            # Create the final model with both the preprocessor and the trained model
